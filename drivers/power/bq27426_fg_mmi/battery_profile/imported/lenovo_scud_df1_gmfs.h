...
//this file is generated from Lenovo-2660-DF1_.gm.fs at Thu Nov 28 16:22:59 2019

#ifndef __SCUD_BQFS_FILE__
#define __SCUD_BQFS_FILE__

#include "bqfs_cmd_type.h"

const bqfs_cmd_t scud_bqfs_image[] = {
	{
		.cmd_type	= CMD_W,
		.addr		= 0xAA,
		.reg		= 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x64, 0x71, 0x0F, 0x9F, 0x23, 0x01, 0x00, 0x14, 0x04, 0x00, 0x09, 0x04, 0x26, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x26, 0x60, 0x11, 0x2D, 0xE5, 0xE5, 0xE0, 0xE1, 0xE1, 0xE1, 0xE3, 0xE4, 0xE2, 0xE6, 0xF1, 0xE6, 0xC0, 0xEA, 0xF7, 0xE6, 0xE0, 0xEA, 0xEB, 0xF1, 0xF1, 0xF6, 0xF5, 0xF7, 0xF8, 0xFA, 0xFA, 0xFC}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0xF7, 0xF7, 0xF0, 0xF5, 0xE9, 0xF8, 0xFE, 0xFB, 0xDF, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFD, 0x6C, 0x05, 0x02, 0x01, 0x03, 0x02, 0x00, 0x02, 0xFC, 0xFB, 0x03, 0xFA, 0xEE, 0xFC, 0x4D, 0xFB, 0xFB, 0xF9, 0xEC, 0x04, 0x01, 0x01, 0x04, 0xFB, 0x00, 0x00, 0xFD, 0xFB, 0xF9, 0xE4, 0xEA}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFD, 0xFA, 0x07, 0xFC, 0x09, 0x0D, 0x04, 0xD8, 0xF6, 0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x37, 0x00, 0x15, 0x07, 0xFC, 0x0A, 0x10, 0x0B, 0x01, 0xF9, 0xF5, 0xFD, 0x0D, 0x26, 0x6B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0x2A, 0x01, 0x00, 0x0C, 0x1C, 0xF7, 0xFB, 0x07, 0xC5, 0xF4, 0xF9, 0xFC, 0xED, 0xFF, 0x40, 0x51, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x14, 0x00, 0x13, 0x00, 0x14, 0x00, 0x18, 0x00, 0x14, 0x00, 0x12, 0x00, 0x15, 0x00, 0x12, 0x00, 0x12, 0x00, 0x13, 0x00, 0x15, 0x00, 0x17, 0x00, 0x1C, 0x00, 0x30, 0x00, 0x62, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x0F, 0xE4, 0x0E, 0xE3, 0x0E, 0xB7, 0x11, 0x2D, 0x10, 0xFB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,

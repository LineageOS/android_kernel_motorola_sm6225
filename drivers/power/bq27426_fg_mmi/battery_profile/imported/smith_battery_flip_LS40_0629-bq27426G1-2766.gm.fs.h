...
const bqfs_cmd_t smith_flip_bqfs_image[] = {
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x41, 0x1E, 0x00, 0x00, 0x00, 0x81, 0x06, 0x09, 0x17, 0x5B, 0x0B, 0xB8, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8, 0x01, 0x00, 0x9B, 0x00, 0x0A, 0xFE, 0xF6, 0xFE, 0xF9, 0x00, 0x06, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,

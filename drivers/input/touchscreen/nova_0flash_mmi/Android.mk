...
ifneq ($(BOARD_USES_DOUBLE_TAP),)
	...
	KBUILD_OPTIONS += CONFIG_INPUT_NOVA_0FLASH_MMI_ENABLE_DOUBLE_TAP=y
endif

ifeq ($(NVT_WAKEUP_GESTURE_CTRL),true)
	KERNEL_CFLAGS += CONFIG_NVT_WAKEUP_GESTURE_CTRL=y
	KBUILD_OPTIONS += CONFIG_NVT_WAKEUP_GESTURE_CTRL=y
endif

ifeq ($(TOUCHSCREEN_LAST_TIME),true)
	KBUILD_OPTIONS += CONFIG_NOVA_TOUCH_LAST_TIME=y
endif

ifeq ($(CONFIG_INPUT_HIGH_RESOLUTION_N),true)
	KERNEL_CFLAGS += CONFIG_INPUT_HIGH_RESOLUTION_N=y
endif
...
ifeq ($(CONFIG_INPUT_ENABLE_DRM_PANEL),true)
	...
	KBUILD_OPTIONS += CONFIG_INPUT_NOVA_DRM_PANEL=y
endif

ifeq ($(CONFIG_INPUT_NOVA_USES_CHIP_VER_1),true)
	KERNEL_CFLAGS += CONFIG_INPUT_NOVA_CHIP_VER_1=y
	KBUILD_OPTIONS += CONFIG_INPUT_NOVA_CHIP_VER_1=y
endif
...
ifeq ($(NVT_SPI_TIMING_CTRL),true)
	KBUILD_OPTIONS += CONFIG_SPI_SM8450=y
endif
...
ifneq ($(findstring touchscreen_mmi.ko,$(BOARD_VENDOR_KERNEL_MODULES)),)
	KBUILD_OPTIONS += CONFIG_INPUT_TOUCHSCREEN_MMI_NVT=y

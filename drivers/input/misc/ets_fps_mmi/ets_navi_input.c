 ...
 */
#if CONFIG_INPUT_EGISTEC_FPS_POSE==0
#define	KEYEVENT_UP				KEY_FPS_YMINUS  /* KEY_UP */
#define	KEYEVENT_DOWN			KEY_FPS_YPLUS  /* KEY_DOWN */
#elif CONFIG_INPUT_EGISTEC_FPS_POSE==90
#define	KEYEVENT_UP				KEY_FPS_XPLUS   /* KEY_UP */
#define	KEYEVENT_DOWN			KEY_FPS_XMINUS  /* KEY_DOWN */
#elif CONFIG_INPUT_EGISTEC_FPS_POSE==180
#define	KEYEVENT_UP				KEY_FPS_YPLUS   /* KEY_UP */
#define	KEYEVENT_DOWN			KEY_FPS_YMINUS  /* KEY_DOWN */
#else  /* 270 */
 ...
 */
#if CONFIG_INPUT_EGISTEC_FPS_POSE==0
#define	KEYEVENT_RIGHT			KEY_FPS_XPLUS   /* KEY_RIGHT */
#define	KEYEVENT_LEFT			KEY_FPS_XMINUS  /* KEY_LEFT */
#elif CONFIG_INPUT_EGISTEC_FPS_POSE==90
#define	KEYEVENT_RIGHT			KEY_FPS_YPLUS   /* KEY_RIGHT */
#define	KEYEVENT_LEFT			KEY_FPS_YMINUS  /* KEY_LEFT */
#elif CONFIG_INPUT_EGISTEC_FPS_POSE==180
#define	KEYEVENT_RIGHT			KEY_FPS_XMINUS  /* KEY_RIGHT */
#define	KEYEVENT_LEFT			KEY_FPS_XPLUS   /* KEY_LEFT */
#else  /* 270 */

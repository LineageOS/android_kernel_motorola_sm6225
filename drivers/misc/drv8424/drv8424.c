...
static motor_stage initial_data_2p3[SQ_SLOWMO + 1][MAX_STAGE_LEGS] = {
	{ /* FULL 39mm */
		{400,60}, {600,60}, {800,60}, {1000,60}, {1200,60}, {1600,60}, {1800,4400},
	},
	{ /* PROLONGED 44mm */
		{400,60}, {600,60}, {800,60}, {1000,60}, {1200,60}, {1600,60}, {1800,5300},
	},
	{ /* SHORT 5mm */
...
static __ref int detection_kthread(void *arg)
{
	...
	while (!kthread_should_stop()) {
		...
		RESET_SENSOR_DATA;
		LOGD("detected position: %s with %d samples\n", position_labels[position], samples);
	}

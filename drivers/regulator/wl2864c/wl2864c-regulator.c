...
static int wl2864c_get_error_flags(struct regulator_dev *rdev, unsigned int *flags)
{
...
static int wl2864c_get_status(struct regulator_dev *rdev)
{
	...
	wl2864c_get_error_flags(rdev, NULL);
...
static const struct regulator_ops wl2864c_regl_ops = {
	...
	.get_error_flags = wl2864c_get_error_flags,
};
			      ...
			      const struct i2c_device_id *id)
{
	...
	wl2864c_get_error_flags(chip->rdev[0], NULL);
